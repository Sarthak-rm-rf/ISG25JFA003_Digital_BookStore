        ...
        <div class="mb-8 p-4 bg-red-50 border border-red-200 rounded-lg">
          <div class="flex items-center mb-4">
            ...
            <h2 class="text-lg font-semibold text-red-800">
              ...
              {{ getLowStockItems().length === 1 ? 'book' : 'books' }} need attention
            </h2>
          </div>
          <div class="space-y-3">
            @for (item of getLowStockItems(); track item.inventoryId) {
            <div
              class="flex items-center justify-between bg-white p-3 rounded-lg border border-red-100"
            >
        ...
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
          <div class="mt-3">
            <div class="flex items-center justify-between mb-4">
              ...
              <button (click)="cancelUpdateStock()" class="text-gray-400 hover:text-gray-600">
